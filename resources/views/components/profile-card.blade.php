    ...
    <div class="card-content">
        ...
        <div class="row">
            ...
            <div class="offset-m1 col m9 offset-s1 col s9">
                <p class="blue-text text-darken-3">Tommy Caldwell</p>
        ...
        <p>I like long days of moderate climbing, both trad and sport. 
            In recent months I've been staying away from strenuous sport/gym 
            climbing to appease a slightly agitated elbow.</p>
    </div>
</div>